...
_NOTABLE = [
    ...
    (1954, 5, "Brown v. Board of Education", "segregation|court|schools|negro"),
    ...
    (2004, 12, "Indian Ocean tsunami", "tsunami|asia|tidal"),
    ...
    (2010, 4, "Deepwater Horizon", "oil|gulf|spill|rig"),
